...
function Calendars() {
  ...
  const handleDelete = async (calendar_id) => {
    try {
      ...
      const updatedCalendars = calendars.filter(calendar => calendar.id !== calendar_id);
      ...
      <div className="relative flex flex-col justify-center md:py-6 mb-4">
        <div className="flex flex-col items-center mx-auto max-w-screen-lg">
          <div className="grid w-full gap-10 grid-cols-1 md:grid-cols-3 px-5 md:px-0">
            ...
            <Link to="/addcalendar" className="hover:bg-gray-500 cursor-pointer w-full rounded-lg shadow-md md:flex flex-col transition-all overflow-hidden hover:shadow-2xl border-dotted border-2 border-gray-300">
              ...
              <div key={index} className="bg-white w-full rounded-lg shadow-md flex flex-col transition-all overflow-hidden hover:shadow-2xl">
                <div className="p-6">
                  ...
                  <h3 className="mb-4 font-semibold text-2xl font-staatliches">
                    <Link to={`/calendar_view/${cal.id}`} className="custom-hover custom-blue font-staatliches hover:text-[#F44336]">{cal.title}</Link>
                  </h3>
