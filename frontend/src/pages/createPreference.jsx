...
function CreatePreference() {
    ...
    const handleSubmit = async (e) => {
      e.preventDefault();
      try {
        const response = await fetch(`http://127.0.0.1:8000/calendars/${cid}/preference/create/`, {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
            Authorization: `Bearer ${token}`,
    ...
    return (
        <>
          ...
          <div className="container mx-auto mt-8">
            <h1 className="text text-6xl text-center mt-20 font-staatliches mt-10 text-white mb-10">Create New Preference</h1>
